...
function getPendingAssignments(client, request, config) {
    return __awaiter(this, void 0, void 0, function* () {
        const resp = yield client.get(`/`, Object.assign(Object.assign({}, config), { params: Object.assign(Object.assign(Object.assign({}, request), { repid: shared_1.ReportId.PENDING_ASSIGNMENT }), config === null || config === void 0 ? void 0 : config.params) }));
        return resp.data;
    });
}
