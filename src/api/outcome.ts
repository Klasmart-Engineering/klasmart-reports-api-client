...
export async function getStudentLearningOutcome (client: AxiosInstance, request: StudentLearningOutcomeRequest, config?: AxiosRequestConfig) {
    ...
    const learningOutComeData = <StudentLearningOutcomeResponse>{
        ...resp.data,
        info: {
            ...resp.data.info,
...
export function useGetStudentLearningOutcome (request: StudentLearningOutcomeRequest, options?: RequestConfigQueryOptions<StudentLearningOutcomeResponse>) {
